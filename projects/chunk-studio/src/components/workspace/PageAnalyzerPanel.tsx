    ...
    >
      ...
      >
        <label style={{ display: "grid", gap: 4, fontSize: 12, color: "#334155" }}>
          ...
          <select
            value={familyHint}
            onChange={(e) => onFamilyHintChange(e.target.value as DocumentFamily)}
            style={selector}
          >
          ...
          {pageProfiles.map((profile) => (
            <button
              ...
              style={{
                ...
                border: "1px solid #dbe3f1",
                borderRadius: 10,
                background: currentPage === profile.pageNumber ? "rgba(59,130,246,0.08)" : "#fff",
                padding: 10,
                display: "grid",
                gap: 6,
                cursor: "pointer",
            ...
            >
              ...
              <label style={{ display: "grid", gap: 4, fontSize: 11, color: "#475569" }}>
                ...
                <select
                  ...
                  onChange={(event) => {
                    ...
                    onOverrideOrientation(profile.pageNumber, event.target.value as PageOrientation);
                  }}
              ...
              <label style={{ display: "grid", gap: 4, fontSize: 11, color: "#475569" }}>
                ...
                <select
                  ...
                  onChange={(event) => {
                    event.stopPropagation();
                    onOverridePageType(profile.pageNumber, event.target.value as PageType);
                  }}
                  onClick={(event) => event.stopPropagation()}
                  style={selector}
                >
              ...
              <label style={{ display: "grid", gap: 4, fontSize: 11, color: "#475569" }}>
                ...
                <select
                  ...
                  onChange={(event) => {
                    event.stopPropagation();
                    onOverrideSubType(profile.pageNumber, event.target.value as PageSubType);
                  }}
                  onClick={(event) => event.stopPropagation()}
                  style={selector}
                >
