...
export function buildFullSemanticForUltimateGovernanceReview() {
...
export function buildUltimateGovernanceReviewBaseReports() {
  return stripRuntimeUltimateGovernanceReviewLayer(buildFullSemanticForUltimateGovernanceReview());
}

export function buildUltimateGovernanceReviewPlanning(
  patches: Partial<RuntimeSemanticPlanningReportsBeforeUltimateGovernanceReview> = {}
) {
  return buildRuntimeUltimateGovernanceReviewPlanningReports({
