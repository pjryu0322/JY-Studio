...
describe("buildOverlayControlledEnforcementGovernanceSectionVm", () => {
  it("includes H11.5 disclaimer and dependency rows", () => {
    ...
    const vm = buildOverlayControlledEnforcementGovernanceSectionVm({
      overlay: null,
    ...
    expect(vm.dependencyRows.length).toBeGreaterThan(0);
  });
});
