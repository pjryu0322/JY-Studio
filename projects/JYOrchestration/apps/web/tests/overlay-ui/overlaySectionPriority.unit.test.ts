...
describe("resolveOverlaySectionPriority", () => {
  ...
  it("marks controlled enforcement governance as normal priority", () => {
    ...
    expect(resolveOverlaySectionPriority("runtime_lifecycle")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_coherence")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_consolidated")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_dependency")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_criticality")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_traceability")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_reasoning")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_semantic")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_semantic_graph")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_semantic_narrative")).toBe("important");
    expect(resolveOverlaySectionPriority("runtime_planning_semantic_vocabulary")).toBe("important");
