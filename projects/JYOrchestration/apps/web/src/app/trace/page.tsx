...
const timelineSteps = [
  { label: "요구사항", hint: "승인·스펙" },
  { label: "기능", hint: "범위 단위" },
  { label: "작업", hint: "실행 단위" },
  { label: "실행 결과", hint: "로그·PR" },
] as const;
...
export default function TracePage() {
  return (
    <div>
      <WorkflowPageHeader
        title="추적"
        subtitle="요구사항 ↔ 기능 ↔ 작업 ↔ 실행 결과를 한눈에 잇는 화면입니다. 데이터가 쌓이면 타임라인이 채워집니다."
        backHref="/execution"
        backLabel="실행으로"
      />
      ...
      <div style={{ marginTop: 14, display: "grid", gap: 14 }}>
        ...
        <WorkflowCard padding={16}>
          ...
          <p style={{ margin: "0 0 12px 0", fontSize: 14, color: "#475569", lineHeight: 1.65 }}>
            요구사항 분석과 실행 계획을 마치면, 작업·실행 단계에서 자동으로 추적 후보가 생깁니다.
          </p>
        ...
        <WorkflowCard padding={16}>
          ...
          <p style={{ margin: "0 0 10px 0", fontSize: 13, color: "#64748b", lineHeight: 1.55 }}>
            협업 세션·작업 URL을 알고 있다면 실행·작업 화면에서 바로 열 수 있습니다.
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
