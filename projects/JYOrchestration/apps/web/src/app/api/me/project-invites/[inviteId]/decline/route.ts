...
import { declineProjectMemberInvite } from "@/lib/service/projectMemberInviteService";
...
export async function POST(
  ...
  try {
    ...
    const result = await declineProjectMemberInvite({ inviteId: id, sessionUserId: userId });
    if (!result.ok) {
    ...
    console.error("POST .../decline error:", error);
