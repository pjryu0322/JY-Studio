...
export async function GET(request: NextRequest) {
  ...
  const responseData: Record<string, unknown> = {
      ...
      runtimeRunnerNoopHarnessReadinessVerificationReport:
        runtimeSemanticDiag.runtimeRunnerNoopHarnessReadinessVerificationReport,
      runtimeRunnerNoopHarnessAlignmentReport: runtimeSemanticDiag.runtimeRunnerNoopHarnessAlignmentReport,
      runtimeRunnerNoopHarnessFinalSafetyGate: runtimeSemanticDiag.runtimeRunnerNoopHarnessFinalSafetyGate,
      runtimeNoopExecutionShellSummary: runtimeSemanticDiag.runtimeNoopExecutionShellSummary,
      runtimeNoopExecutionShellScope: runtimeSemanticDiag.runtimeNoopExecutionShellScope,
      runtimeNoopExecutionShellPolicy: runtimeSemanticDiag.runtimeNoopExecutionShellPolicy,
      runtimeNoopExecutionShellBlockerReport: runtimeSemanticDiag.runtimeNoopExecutionShellBlockerReport,
      runtimeNoopExecutionShellReadinessChecklist:
        runtimeSemanticDiag.runtimeNoopExecutionShellReadinessChecklist,
      runtimeNoopExecutionShellFinalSafetyGate: runtimeSemanticDiag.runtimeNoopExecutionShellFinalSafetyGate,
      ...
      runtimeExecutionBoundaryShellSummary: runtimeSemanticDiag.runtimeExecutionBoundaryShellSummary,
      runtimeExecutionBoundaryShellScope: runtimeSemanticDiag.runtimeExecutionBoundaryShellScope,
      runtimeExecutionBoundaryShellPolicy: runtimeSemanticDiag.runtimeExecutionBoundaryShellPolicy,
      ...
      runtimeExecutionGovernanceBoundaryViolationReport:
        runtimeSemanticDiag.runtimeExecutionGovernanceBoundaryViolationReport,
      runtimeExecutionGovernanceBoundaryReadinessVerificationReport:
        runtimeSemanticDiag.runtimeExecutionGovernanceBoundaryReadinessVerificationReport,
      runtimeExecutionGovernanceBoundaryAlignmentReport:
        runtimeSemanticDiag.runtimeExecutionGovernanceBoundaryAlignmentReport,
      runtimeExecutionGovernanceBoundaryFinalSafetyGate:
        runtimeSemanticDiag.runtimeExecutionGovernanceBoundaryFinalSafetyGate,
      runtimeGovernanceReleaseReadinessSummary:
        runtimeSemanticDiag.runtimeGovernanceReleaseReadinessSummary,
      runtimeGovernanceReleaseReadinessBoundary:
        runtimeSemanticDiag.runtimeGovernanceReleaseReadinessBoundary,
      runtimeGovernanceReleaseInputEnvelope: runtimeSemanticDiag.runtimeGovernanceReleaseInputEnvelope,
      runtimeGovernanceReleaseOutputEnvelope: runtimeSemanticDiag.runtimeGovernanceReleaseOutputEnvelope,
      runtimeGovernanceNoEnforcementProof: runtimeSemanticDiag.runtimeGovernanceNoEnforcementProof,
      runtimeExecutionGovernanceForbiddenProof:
        runtimeSemanticDiag.runtimeExecutionGovernanceForbiddenProof,
      runtimeGovernanceReleaseBlockerReport: runtimeSemanticDiag.runtimeGovernanceReleaseBlockerReport,
      runtimeGovernanceReleaseReadinessChecklist:
        runtimeSemanticDiag.runtimeGovernanceReleaseReadinessChecklist,
      runtimeGovernanceReleaseReadinessViolationReport:
        runtimeSemanticDiag.runtimeGovernanceReleaseReadinessViolationReport,
      runtimeGovernanceReleaseReadinessVerificationReport:
        runtimeSemanticDiag.runtimeGovernanceReleaseReadinessVerificationReport,
      ...
      runtimeFinalReleaseGovernanceGateViolationReport:
        runtimeSemanticDiag.runtimeFinalReleaseGovernanceGateViolationReport,
      runtimeFinalReleaseGovernanceGateVerificationReport:
        runtimeSemanticDiag.runtimeFinalReleaseGovernanceGateVerificationReport,
      ...
      runtimeUltimateGovernanceReviewViolationReport:
        runtimeSemanticDiag.runtimeUltimateGovernanceReviewViolationReport,
      runtimeUltimateGovernanceReviewVerificationReport:
        runtimeSemanticDiag.runtimeUltimateGovernanceReviewVerificationReport,
      runtimeUltimateGovernanceReviewAlignmentReport:
        runtimeSemanticDiag.runtimeUltimateGovernanceReviewAlignmentReport,
      runtimeUltimateGovernanceReviewFinalSafetyGate:
        runtimeSemanticDiag.runtimeUltimateGovernanceReviewFinalSafetyGate,
      runtimeControlledActivationCandidateSummary:
        runtimeSemanticDiag.runtimeControlledActivationCandidateSummary,
      runtimeControlHandoffBoundary: runtimeSemanticDiag.runtimeControlHandoffBoundary,
      runtimeControlledActivationCandidateScope:
        runtimeSemanticDiag.runtimeControlledActivationCandidateScope,
      runtimeControlledActivationCandidatePolicy:
        runtimeSemanticDiag.runtimeControlledActivationCandidatePolicy,
      runtimeControlledActivationCandidateBlockerReport:
        runtimeSemanticDiag.runtimeControlledActivationCandidateBlockerReport,
      runtimeControlledActivationReadinessChecklist:
        runtimeSemanticDiag.runtimeControlledActivationReadinessChecklist,
      runtimeControlledActivationCandidateViolationReport:
        runtimeSemanticDiag.runtimeControlledActivationCandidateViolationReport,
      runtimeControlledActivationCandidateVerificationReport:
        runtimeSemanticDiag.runtimeControlledActivationCandidateVerificationReport,
      runtimeControlledActivationCandidateAlignmentReport:
        runtimeSemanticDiag.runtimeControlledActivationCandidateAlignmentReport,
      runtimeControlledActivationCandidateFinalSafetyGate:
        runtimeSemanticDiag.runtimeControlledActivationCandidateFinalSafetyGate,
      runtimeLimitedPilotBoundarySummary: runtimeSemanticDiag.runtimeLimitedPilotBoundarySummary,
      runtimeLimitedPilotBoundaryScope: runtimeSemanticDiag.runtimeLimitedPilotBoundaryScope,
      runtimeLimitedPilotBoundaryPolicy: runtimeSemanticDiag.runtimeLimitedPilotBoundaryPolicy,
      runtimeLimitedPilotInputContract: runtimeSemanticDiag.runtimeLimitedPilotInputContract,
      runtimeLimitedPilotOutputContract: runtimeSemanticDiag.runtimeLimitedPilotOutputContract,
      ...
      runtimeLimitedPilotReadinessReviewSummary:
        runtimeSemanticDiag.runtimeLimitedPilotReadinessReviewSummary,
      runtimePilotContractHardeningBoundary: runtimeSemanticDiag.runtimePilotContractHardeningBoundary,
      runtimePilotReadinessInputEnvelope: runtimeSemanticDiag.runtimePilotReadinessInputEnvelope,
      runtimePilotReadinessOutputEnvelope: runtimeSemanticDiag.runtimePilotReadinessOutputEnvelope,
      runtimePilotNoExecutionProof: runtimeSemanticDiag.runtimePilotNoExecutionProof,
      runtimePilotExecutionForbiddenProof: runtimeSemanticDiag.runtimePilotExecutionForbiddenProof,
      runtimePilotReadinessBlockerReport: runtimeSemanticDiag.runtimePilotReadinessBlockerReport,
      runtimePilotContractReadinessChecklist: runtimeSemanticDiag.runtimePilotContractReadinessChecklist,
      runtimeLimitedPilotReadinessReviewViolationReport:
        runtimeSemanticDiag.runtimeLimitedPilotReadinessReviewViolationReport,
      runtimeLimitedPilotReadinessReviewVerificationReport:
        runtimeSemanticDiag.runtimeLimitedPilotReadinessReviewVerificationReport,
      runtimeLimitedPilotReadinessReviewAlignmentReport:
        runtimeSemanticDiag.runtimeLimitedPilotReadinessReviewAlignmentReport,
      runtimeLimitedPilotReadinessReviewFinalSafetyGate:
        runtimeSemanticDiag.runtimeLimitedPilotReadinessReviewFinalSafetyGate,
      runtimePilotExecutionReadinessSummary: runtimeSemanticDiag.runtimePilotExecutionReadinessSummary,
      runtimePilotExecutionReadinessBoundary: runtimeSemanticDiag.runtimePilotExecutionReadinessBoundary,
      runtimePilotExecutionReadinessInputEnvelope: runtimeSemanticDiag.runtimePilotExecutionReadinessInputEnvelope,
      runtimePilotExecutionReadinessOutputEnvelope: runtimeSemanticDiag.runtimePilotExecutionReadinessOutputEnvelope,
      runtimeFinalPilotNoExecutionProof: runtimeSemanticDiag.runtimeFinalPilotNoExecutionProof,
      ...
      runtimeControlledPilotExecutionCandidateSummary:
        runtimeSemanticDiag.runtimeControlledPilotExecutionCandidateSummary,
      runtimeFinalRuntimeHandoffBoundary: runtimeSemanticDiag.runtimeFinalRuntimeHandoffBoundary,
      runtimeControlledPilotExecutionCandidateScope:
        runtimeSemanticDiag.runtimeControlledPilotExecutionCandidateScope,
      runtimeControlledPilotExecutionCandidatePolicy:
        runtimeSemanticDiag.runtimeControlledPilotExecutionCandidatePolicy,
      runtimeControlledPilotExecutionInputContract:
        runtimeSemanticDiag.runtimeControlledPilotExecutionInputContract,
      runtimeControlledPilotExecutionOutputContract:
        runtimeSemanticDiag.runtimeControlledPilotExecutionOutputContract,
