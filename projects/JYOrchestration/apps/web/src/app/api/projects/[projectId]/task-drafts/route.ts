  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: rows.map((r) => ({
        ...
        taskInput: (r as { taskInput?: string | null }).taskInput ?? null,
        taskOutput: (r as { taskOutput?: string | null }).taskOutput ?? null,
        estimatedSize: (r as { estimatedSize?: string | null }).estimatedSize ?? null,
        executionKind: (r as { executionKind?: string | null }).executionKind ?? null,
