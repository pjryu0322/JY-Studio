 ...
 * - GIT_BRANCH_REFLECTED → 원격 브랜치·compare·HEAD 확인 (`runEnvTestReflectionConfirmedPipeline` / `runEnvTestReflectionNotConfirmedGithubBypass` / `runEnvTestAfterGithubPushConfirmed`)
