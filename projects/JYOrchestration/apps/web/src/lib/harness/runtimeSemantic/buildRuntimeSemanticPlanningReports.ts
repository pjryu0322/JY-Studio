...
import type {
  ...
  RuntimeSemanticPlanningReportsBeforePilotExecutionReadiness,
...
export function buildRuntimeSemanticPlanningReports(
  ...
  const semanticWithLimitedPilotReadinessReview: RuntimeSemanticPlanningReportsBeforePilotExecutionReadiness = {
    ...semanticWithLimitedPilotBoundary,
    ...limitedPilotReadinessReviewReports,
  };

  const pilotExecutionReadinessReports = buildRuntimePilotExecutionReadinessPlanningReports(
  ...
  const semanticWithControlledPilotExecutionCandidate = {
    ...semanticWithPilotExecutionReadiness,
    ...controlledPilotExecutionCandidateReports,
  };

  const pilotValidationReadOnlyChainReports = buildRuntimePilotValidationReadOnlyChainPlanningReports(
    semanticWithControlledPilotExecutionCandidate
  );

  return {
    ...semanticWithControlledPilotExecutionCandidate,
    ...pilotValidationReadOnlyChainReports,
  };
}
