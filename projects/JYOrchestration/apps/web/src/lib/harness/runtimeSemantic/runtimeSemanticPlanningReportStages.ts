...
/** H36 포함 — execution boundary metadata shell candidate까지 산출된 상태. */
export type RuntimeSemanticPlanningReports = RuntimeSemanticPlanningReportsBeforeExecutionBoundaryShell &
