/**
 * H35 / H35.5 — release-gate final preflight overlay·진단 **한국어 라벨**(read-only).
 */

import type {
  RuntimeReleaseGatePreflightAlignmentStatus,
  RuntimeReleaseGatePreflightFinalGateStatus,
  RuntimeReleaseGatePreflightMode,
  RuntimeReleaseGatePreflightReadiness,
  RuntimeReleaseGatePreflightReadinessVerificationStatus,
...
export const RUNTIME_RELEASE_GATE_PREFLIGHT_FINAL_GATE_STATUS_LABEL_KO: Readonly<
  Record<RuntimeReleaseGatePreflightFinalGateStatus, string>
> = {
...
export const RUNTIME_RELEASE_GATE_PREFLIGHT_READINESS_VERIFICATION_STATUS_LABEL_KO: Readonly<
  Record<RuntimeReleaseGatePreflightReadinessVerificationStatus, string>
> = {
...
export const RUNTIME_RELEASE_GATE_PREFLIGHT_ALIGNMENT_STATUS_LABEL_KO: Readonly<
  Record<RuntimeReleaseGatePreflightAlignmentStatus, string>
> = {
