...
const EXECUTION_LOG_ACTION_LABELS: Record<string, string> = {
  ...
  implementation_integration_branch_already_exists: "통합 branch 이미 존재",
  implementation_integration_branch_reused: "기존 통합 branch 재사용",
  implementation_integration_branch_state_recovered: "통합 branch step 상태 복구",
  implementation_integration_final_wiring_state_recovered: "최종 Wiring step 상태 복구",
  implementation_codetask_branch_already_integrated: "CodeTask branch 이미 통합됨",
  ...
  implementation_execution_unit_github_poll_scheduled: "CodeTask GitHub poll 예약 (60초 후)",
  implementation_execution_unit_github_poll_waiting: "CodeTask GitHub poll 대기 (Cursor 반영)",
  implementation_execution_unit_github_poll_started: "CodeTask GitHub poll 시작",
  implementation_execution_unit_github_branch_lookup_requested: "GitHub work branch 조회",
  implementation_execution_unit_github_branch_missing_retry_scheduled: "GitHub branch 없음 — 재시도 예약",
  implementation_execution_unit_github_head_commit_resolved: "GitHub head commit 확인",
  implementation_execution_unit_github_verify_passed: "CodeTask GitHub 검증 성공",
  implementation_execution_unit_github_verify_timeout: "CodeTask GitHub 검증 timeout",
  implementation_execution_unit_github_verify_failed: "CodeTask GitHub 검증 실패",
