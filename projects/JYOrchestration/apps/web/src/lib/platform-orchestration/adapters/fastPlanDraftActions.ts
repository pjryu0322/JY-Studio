...
export const FAST_PLAN_ACTION_GO_IMPLEMENTATION_STAGE = IMPLEMENTATION_STAGE_NAVIGATE_LABEL;
export const FAST_PLAN_ACTION_REFINE_PLAN = IMPLEMENTATION_REFINE_LABEL;
export const FAST_PLAN_ACTION_REFINE_PLANNING_INFO = PLANNING_INFO_REFINE_LABEL;
export const FAST_PLAN_ACTION_VIEW_PLANNING_ARTIFACTS = PLANNING_ARTIFACT_VIEW_LABEL;
