...
function buildIntentRouterSystemPrompt(): string {
  return [
    ...
    "- feature_planning: features, MVP scope, function list, feature scope, feature priority, requirements feature list.",
    "When the user asks to organize feature scope, MVP scope, core features, feature list, or feature priority, use feature_planning — not service_flow or flow_step_definition.",
