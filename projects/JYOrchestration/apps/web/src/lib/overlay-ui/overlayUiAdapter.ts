...
export type OverlayUiSectionDefaultsVM = Readonly<{
  ...
  /** Harness Phase H12.5 — Runtime priority & escalation(기본 접힘; escalation 시 SummaryCard에서 펼침). */
  runtimePriority: boolean;
  /** Harness Phase H13.5 — Runtime lifecycle governance(기본 접힘; stale 시 SummaryCard에서 펼침). */
  ...
  /** Harness Phase H21 — Runtime resource governance(기본 접힘; risk·review 시 펼침). */
  ...
  /** Harness Phase H26 — Runtime adapter sandbox readiness·envelope(기본 접힘; blocker 시 펼침). */
  runtimePlanningRuntimeAdapterSandbox: boolean;
  /** Harness Phase H27 — Runtime pilot activation candidate(기본 접힘; blocker·watch 시 펼침). */
  runtimePlanningRuntimePilotActivation: boolean;
  /** Harness Phase H28 — Runtime pilot skeleton·dry-run runner contract(기본 접힘; blocker 시 펼침). */
  ...
  /** Harness Phase H30 — Runner no-op harness(기본 접힘; blocker 시 펼침). */
  ...
  /** Harness Phase H36 — Execution boundary metadata shell candidate(기본 접힘; blocker 시 펼침). */
  ...
  /** H44 pilot execution readiness boundary. */
  runtimePlanningRuntimePilotExecutionReadiness: boolean;
  /** H45 controlled pilot execution candidate·final runtime handoff boundary. */
  runtimePlanningRuntimeControlledPilotExecutionCandidate: boolean;
  /** Pilot Validation Phase 0 — read-only chain validation summary. */
  runtimePlanningPilotValidationReadOnlyChain: boolean;
}>;
...
function buildSectionDefaults(
  ...
  return {
    ...
    runtimePlanningRuntimeAdapterSandbox: false,
    ...
    runtimePlanningRuntimePilotExecutionReadiness: false,
    runtimePlanningRuntimeControlledPilotExecutionCandidate: false,
    runtimePlanningPilotValidationReadOnlyChain: false,
  };
}
