...
import {
  buildOverlayRuntimeAdapterSandboxSectionVmFromReports,
  type OverlayRuntimeAdapterSandboxSectionVM,
} from "./overlayRuntimeAdapterSandboxSectionVm";
import {
  buildOverlayRuntimePilotActivationSectionVmFromReports,
  type OverlayRuntimePilotActivationSectionVM,
} from "./overlayRuntimePilotActivationSectionVm";
import {
...
import {
  buildOverlayRuntimeRunnerNoopHarnessSectionVmFromReports,
  type OverlayRuntimeRunnerNoopHarnessSectionVM,
} from "./overlayRuntimeRunnerNoopHarnessSectionVm";
import {
  buildOverlayRuntimeNoopExecutionShellSectionVmFromReports,
  type OverlayRuntimeNoopExecutionShellSectionVM,
} from "./overlayRuntimeNoopExecutionShellSectionVm";
import {
  buildOverlayRuntimeNoopExecutionShellHarnessSectionVmFromReports,
  type OverlayRuntimeNoopExecutionShellHarnessSectionVM,
} from "./overlayRuntimeNoopExecutionShellHarnessSectionVm";
import {
  buildOverlayRuntimeNoopShellHardeningSectionVmFromReports,
  type OverlayRuntimeNoopShellHardeningSectionVM,
} from "./overlayRuntimeNoopShellHardeningSectionVm";
import {
...
export type OverlayRuntimePlanningSectionVms = Readonly<{
  ...
  runtimeRunnerNoopHarnessVm: OverlayRuntimeRunnerNoopHarnessSectionVM;
  runtimeNoopExecutionShellVm: OverlayRuntimeNoopExecutionShellSectionVM;
  ...
  runtimeExecutionBoundaryShellVm: OverlayRuntimeExecutionBoundaryShellSectionVM;
  runtimeExecutionGovernanceBoundaryVm: OverlayRuntimeExecutionGovernanceBoundarySectionVM;
  runtimeGovernanceReleaseReadinessVm: OverlayRuntimeGovernanceReleaseReadinessSectionVM;
...
export function buildOverlayRuntimePlanningSectionVms(input: {
  ...
  const runtimeAdapterSandboxVm = buildOverlayRuntimeAdapterSandboxSectionVmFromReports(semanticReports, {
    compactAndNarrowUi: input.compactAndNarrowUi,
  });
  const runtimePilotActivationVm = buildOverlayRuntimePilotActivationSectionVmFromReports(semanticReports, {
    compactAndNarrowUi: input.compactAndNarrowUi,
  });
  ...
  const runtimeRunnerNoopHarnessVm = buildOverlayRuntimeRunnerNoopHarnessSectionVmFromReports(semanticReports, {
    compactAndNarrowUi: input.compactAndNarrowUi,
  });
  const runtimeNoopExecutionShellVm = buildOverlayRuntimeNoopExecutionShellSectionVmFromReports(semanticReports, {
    compactAndNarrowUi: input.compactAndNarrowUi,
  });
  const runtimeNoopExecutionShellHarnessVm = buildOverlayRuntimeNoopExecutionShellHarnessSectionVmFromReports(
    semanticReports,
    {
      compactAndNarrowUi: input.compactAndNarrowUi,
    }
  );
  const runtimeNoopShellHardeningVm = buildOverlayRuntimeNoopShellHardeningSectionVmFromReports(semanticReports, {
    compactAndNarrowUi: input.compactAndNarrowUi,
  });
  ...
  const runtimeExecutionBoundaryShellVm = buildOverlayRuntimeExecutionBoundaryShellSectionVmFromReports(
    semanticReports,
    {
      compactAndNarrowUi: input.compactAndNarrowUi,
    }
  );
  const runtimeExecutionGovernanceBoundaryVm = buildOverlayRuntimeExecutionGovernanceBoundarySectionVmFromReports(
    semanticReports,
    {
      compactAndNarrowUi: input.compactAndNarrowUi,
    }
  );
  const runtimeGovernanceReleaseReadinessVm = buildOverlayRuntimeGovernanceReleaseReadinessSectionVmFromReports(
    semanticReports,
    {
      compactAndNarrowUi: input.compactAndNarrowUi,
    }
  );
  const runtimeFinalReleaseGovernanceGateVm = buildOverlayRuntimeFinalReleaseGovernanceGateSectionVmFromReports(
    semanticReports,
    {
      compactAndNarrowUi: input.compactAndNarrowUi,
    }
  );
  const runtimeUltimateGovernanceReviewVm = buildOverlayRuntimeUltimateGovernanceReviewSectionVmFromReports(
    semanticReports,
    {
      compactAndNarrowUi: input.compactAndNarrowUi,
    }
  );
  const runtimeControlledActivationCandidateVm =
  ...
  const runtimeLimitedPilotReadinessReviewVm =
    buildOverlayRuntimeLimitedPilotReadinessReviewSectionVmFromReports(semanticReports, {
      compactAndNarrowUi: input.compactAndNarrowUi,
    });
  const runtimePilotExecutionReadinessVm = buildOverlayRuntimePilotExecutionReadinessSectionVmFromReports(
    semanticReports,
    { compactAndNarrowUi: input.compactAndNarrowUi }
  );
  const runtimeControlledPilotExecutionCandidateVm =
