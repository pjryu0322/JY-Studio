...
export function evaluateOperatorApprovalAuditWritePathWireApprovalGate(input?: {
  ...
  return {
    ...
    sourcePermissionChecklistItemCount: schemaApproval.permissionAccessChecklist.length,
    sourceAuditChecklistItemCount: schemaApproval.auditIntegrityChecklist.length,
    target,
