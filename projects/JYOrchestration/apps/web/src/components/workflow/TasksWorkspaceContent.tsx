    ...
    <>
      ...
      {view.hasConfirmedTaskSet ? (
        <div className="relative" style={{ border: "1px solid #bbf7d0", borderRadius: 12, padding: 10, background: "#f0fdf4" }}>
          <ScreenLabel label="작업-공식확정-안내-패널" visible={showScreenLabels} />
      ...
      {confirmFlash ? (
        <div className="relative" style={{ border: "1px solid #bfdbfe", borderRadius: 12, padding: 10, background: "#eff6ff" }}>
          <ScreenLabel label="작업-확정-알림-패널" visible={showScreenLabels} />
      ...
      <div className="relative" style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.5 }}>
        <ScreenLabel label="작업-안내-본문-섹션" visible={showScreenLabels} />
      ...
      <div className="relative" style={{ display: "flex", flexWrap: "wrap", gap: 10, alignItems: "center" }}>
        <ScreenLabel label="작업-확정-실행행-섹션" visible={showScreenLabels} />
      ...
      {view.sessionId ? (
        <div className="relative" style={{ fontSize: 13, color: "#374151", lineHeight: 1.5 }}>
          <ScreenLabel label="작업-실행후보-현황-섹션" visible={showScreenLabels} />
      ...
      >
        <ScreenLabel label="작업-실행후보-설명-섹션" visible={showScreenLabels} />
      ...
      <div className="relative" style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
        <ScreenLabel label="작업-목록보기-토글-섹션" visible={showScreenLabels} />
      ...
      <div className="relative">
        <ScreenLabel label="작업-순서-미리보기-패널" visible={showScreenLabels} />
      ...
      {executionLaunchPreview ? (
        <div className="relative">
          <ScreenLabel label="작업-실행입력-미리보기-패널" visible={showScreenLabels} />
      ...
      {executionLaunchPreview ? (
        <div className="relative">
          <ScreenLabel label="작업-실행스냅샷-준비-패널" visible={showScreenLabels} />
          <WorkflowCard padding={12}>
            <details>
      ...
      {working.removedTasks.length > 0 ? (
        <div className="relative">
          <ScreenLabel label="작업-검토제외-목록-패널" visible={showScreenLabels} />
      ...
      <div className="relative">
        <ScreenLabel label="작업-수동추가-폼-패널" visible={showScreenLabels} />
        <WorkflowCard padding={12}>
          <details>
      ...
      <div className="relative">
        <ScreenLabel label="작업-상세목록-패널" visible={showScreenLabels} />
        <WorkflowCard padding={12}>
          <details>
      ...
      <div className="relative">
        <ScreenLabel label="작업-실행-참고-섹션" visible={showScreenLabels} />
        <details>
