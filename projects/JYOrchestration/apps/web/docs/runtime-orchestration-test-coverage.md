...
|----------|--------|-------------------|-------------------|-------|
| P1 | H38.5–H45.5, Pilot Validation Phase 0–1 | yes | H38–H45.5 + Pilot Validation sections + `PilotValidationReviewPanel` | `runtimeShared/runtimeReadOnlyInvariants.ts` + unit test |
