...
|----------|--------|-------------------|-------------------|-------|
| P1 | H38.5–H45.5, Pilot Validation Phase 0–4 | yes | H38–H45.5 + Pilot Validation + request draft + simulator + `PilotValidationReviewPanel` | `runtimeShared/runtimeReadOnlyInvariants.ts` + unit test |
