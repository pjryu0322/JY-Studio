...
- **Harness Phase H5 Preparation — Execution Routing Harness (15단계, 현재; planning metadata only)** — "어떤 AI멤버가 어떤 실행 capability를 가질 수 있는가"를 planning metadata로 설명한다. **실제 provider switching, execution routing, automatic Cursor execution, GitHub PR/merge, retrieval orchestration 어디에도 영향 없음.**
