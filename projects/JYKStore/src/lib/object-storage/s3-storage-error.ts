...
export type S3StorageOperation =
  | "put"
  | "get"
  | "delete"
  | "head"
...
export function classifyS3StorageError(
  ...
  if (hasName(names, "NoSuchKey", "NoSuchUpload")) {
  ...
  if (genericNotFound) {
    ...
    // put/delete/create multipart generic 404 is treated as storage/bucket failure.
    return "bucket-missing";
  }
