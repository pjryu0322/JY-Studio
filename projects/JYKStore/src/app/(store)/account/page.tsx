const ACCOUNT_ITEMS = [
  { title: "API Key 관리", description: "연동용 API Key 발급 및 관리", status: "준비 중" },
  { title: "사용량 확인", description: "지식팩 호출 및 사용량", status: "준비 중" },
  { title: "지식팩 제공자 센터", description: "제공자 등록 및 지식팩 관리", status: "준비 중" },
  { title: "관리자 콘솔", description: "검수 및 운영 도구", status: "준비 중" },
  { title: "설정", description: "알림 및 계정 설정", status: "준비 중" },
] as const;
